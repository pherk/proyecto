...
module namespace style = "http://chlt.es/ns/xquery/style";
...
declare variable $style:web-path-to-site := '/exist/apps/proyecto';
...
declare function style:breadcrumbs($breadcrumbs as node()*) as element(div)* {
    if ($breadcrumbs) then 
        ...
        return
            <div id="breadcrumbs">
                <ul>
                    <li><a href="{$style:web-path-to-site}/index.xq">Home</a> {$breadcrumbDivider}</li>
                    {
...
declare variable $style:cols-3 := (4, 14, 6);
...
declare function style:css() {
    <link rel="stylesheet" href="{$style:web-path-to-site}/resources/css/blueprint/screen.css" type="text/css" media="screen, projection, print"/>,
    <link rel="stylesheet" href="{$style:web-path-to-site}/resources/css/blueprint/print.css" type="text/css" media="print"/>,
    <!--[if IE ]><link rel="stylesheet" href="{$style:web-path-to-site}/css/blueprint/ie.css" type="text/css" media="screen, projection" /><![endif]-->,
    <link rel="stylesheet" href="{$style:web-path-to-site}/resources/css/screen.css" type="text/css" media="screen"/>
};

declare function style:header() {
    <div class="banner span-24 last">
        <div class="span-4">
            <div class="banner inner-left"><h3 color="white">Proyecto<br/>Constitutión<br/>1812<br/>de Cádiz</h3></div>
        </div>
        <div class="banner span-14">
            <div class="banner inner">
                <a href="{$style:web-path-to-site}/v6/list-docs.xq"><img alt="Proyecto de la Constitutión" width="358" height="114" src="{$style:web-path-to-site}/resources/images/banner.png" class="bordered"/></a>
            </div>
        </div>
        <div class="span-6 last">
            <div class="banner inner-right">
                <div class="bannersearch">
                    <div class="searchbox">
                        <form action="{$style:web-path-to-site}/v6/search.xq" method="get">
                            <p>Search:
<br/>
                                <select name="stype">
                                  <option>text</option>
        ...
        <div class="inner">
            <div class="footer bordered">
                <div id="footerlinks">
                    ...
                    <a href="http://chlt.es/">Cadiz Heritage Language Technology</a> | 
